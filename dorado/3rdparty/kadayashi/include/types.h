...
constexpr uint8_t VAR_OP_CONSOLIDATED_MULTIALLELE = 16;
...
constexpr unsigned char kdy_seq_nt4_table[256] = {
        ...
        4, 4,       4, 4,       4,       4,       4, 4,       4, 4, 4, 4, 4, 4,       4,       4,
        4, 0 /*A*/, 4, 1 /*C*/, 4,       4,       4, 2 /*G*/, 4, 4, 4, 4, 4, 4 /*M*/, 4 /*N*/, 4,
...
constexpr uint8_t TA_TYPE_HETMULTI_CONSOLIDATED = 8;
struct ta_t {
    uint32_t pos;
    ...
    uint32_t
            ref_len;  // this is only used by multi-allelic var generated by local variant consolidation
